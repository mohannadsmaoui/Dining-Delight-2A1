...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 08 mai 2021 à 01:18
...
CREATE TABLE `admin_info` (
  ...
  `email_ad` varchar(25) NOT NULL,
  `password-ad` varchar(20) NOT NULL,
  `numtel_ad` int(8) NOT NULL,
  `ville` enum('Tunis','Ariana','Ben Arous','Mannouba','Nabeul','Zaghouane','Bizerte','Béja','Jendouba','Kef','Siliana','Sousse','Monastir','Mahdia','Sfax','kairouane','kassrine','Sidi Bouzid','Gabes','Mednine','Tataouine','Gafsa','Touzeur','kebili') NOT NULL,
  `Typea` enum('Admin') NOT NULL
...
INSERT INTO `admin_info` (`id_admin`, `nom_ad`, `prenom_ad`, `email_ad`, `password-ad`, `numtel_ad`, `ville`, `Typea`) VALUES
(1, 'admin', 'admin@gmail.com', '25f9e794323b453885f5181f1', '', 0, 'Tunis', '');
...
--
-- Structure de la table `email_info`
--
...
--
-- Déchargement des données de la table `email_info`
--
...
CREATE TABLE `user_info` (
  ...
  `prenom_cl` varchar(15) NOT NULL,
  `email_cl` varchar(25) NOT NULL,
  `password_cl` varchar(20) NOT NULL,
  `numtel_cl` int(8) NOT NULL,
  `ville` enum('Tunis','Ariana','Ben Arous','Mannouba','Nabeul','Zaghouane','Bizerte','Béja','Jendouba','Kef','Siliana','Sousse','Monastir','Mahdia','Sfax','kairouane','kassrine','Sidi Bouzid','Gabes','Mednine','Tataouine','Gafsa','Touzeur','kebili') NOT NULL DEFAULT 'Tunis',
  `Typeu` enum('Staff','client','Livreur','') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user_info` (`id_client`, `nom_cl`, `prenom_cl`, `email_cl`, `password_cl`, `numtel_cl`, `ville`, `Typeu`) VALUES
(12, 'puneeth', 'Reddy', 'puneethreddy951@gmail.com', 'puneeth', 94481215, '', 'Staff'),
(15, 'hemu', 'ajhgdg', 'puneethreddy951@gmail.com', '346778', 53648727, '', 'Staff'),
(16, 'venky', 'vs', 'venkey@gmail.com', '1234534', 98776543, '', 'Staff'),
(19, 'abhishek', 'bs', 'abhishekbs@gmail.com', 'asdcsdcc', 98712365, '', 'Staff'),
(21, 'prajval', 'mcta', 'prajvalmcta@gmail.com', '1234545662', 202, '', 'Staff'),
(22, 'puneeth', 'v', 'hemu@gmail.com', '1234534', 98776543, '', 'Staff'),
(23, 'hemanth', 'reddy', 'hemanth@gmail.com', 'Puneeth@123', 98765432, '', 'Staff'),
(24, 'newuser', 'user', 'newuser@gmail.com', 'puneeth@123', 95356889, '', 'Staff'),
(25, 'otheruser', 'user', 'otheruser@gmail.com', 'puneeth@123', 95356889, '', 'Staff');
...
--
-- Index pour la table `email_info`
--
...
--
-- AUTO_INCREMENT pour la table `email_info`
--
ALTER TABLE `email_info`
...
--
ALTER TABLE `user_info`
  MODIFY `id_client` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `orders_info`
  ADD CONSTRAINT `user_id` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id_client`);
