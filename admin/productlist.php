                ...
                <div class="table-responsive ps">
                  <table class="table tablesorter " id="page1">
                    <thead class=" text-primary">
                      <tr><th>Image</th><th>Name</th><th>Prix</th><th>
	<a class=" btn btn-primary" href="addproduct.php">Ajouter nouveau</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <a class=' btn btn-success' href='clothes_list.php?product_id=$product_id&action=delete'>supprimer</a>
                        </td></tr>";
                        }
