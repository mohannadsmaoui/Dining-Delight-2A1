                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="indexlogin.html" class="booking">S'inscrire/Se connecter</a></li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
                    </div><!-- /.container-fluid -->
                </nav>
                ...
                <div class="main_slider text-center">
                    <div class="col-md-12">
                        <div class="main_slider_content wow zoomIn" data-wow-duration="1s">
                            ...
                            <button href="" class="btn-lg">Commandez Maintenant !</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="portfolio_content text-center  wow fadeIn" data-wow-duration="5s">
                <div class="col-md-12">
                    <div class="head_title text-center">
                        <h4>Delightful</h4>
                        <h3>Experience</h3>
                        <a href="Cart.php" class="btn btn-primary">Commandez Maintenant !</a>
                    </div>
                    ...
                    <div class="main_portfolio_content">
                        <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                            ...
                            <div class="portfolio_images_overlay text-center">
                                <h6>Ramen japonaise</h6>
                                <p class="product_price">12DT</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                            <img src="../assets/images/p2.png" alt="" />
                            <div class="portfolio_images_overlay text-center">
                                <h6>Plat proteinés</h6>
                                <p class="product_price">14DT</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                            ...
                            <div class="portfolio_images_overlay text-center">
                                <h6>Feuilles de printemps chinoises</h6>
                                <p class="product_price">20DT</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                            <img src="../assets/images/p5.png" alt="" />
                            <div class="portfolio_images_overlay text-center">
                                <h6>Hamburger vegetarien</h6>
                                <p class="product_price">22DT</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                            <img src="../assets/images/p6.png" alt="" />
                            <div class="portfolio_images_overlay text-center">
                                <h6>Soupe de champigons</h6>
                                <p class="product_price">12.5DT</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                            ...
                            <div class="portfolio_images_overlay text-center">
                                <h6>Riz contonais</h6>
                                <p class="product_price">13DT</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                            <img src="../assets/images/p8.png" alt="" />
                            <div class="portfolio_images_overlay text-center">
                                <h6>poulet au citron</h6>
                                <p class="product_price">21DT</p>
                            </div>
                        </div>
                    </div>
                </div>
