			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
                        ...
                        <tr>
                            <td><a href="index.php" class="btn btn-danger"><i class="fa fa-angle-left"></i> Home</a></td>
                            <td colspan="2" class="hidden-xs"></td>
                            <td class="hidden-xs text-center"><b class="net_total" ></b></td>
                            <div id="issessionset"></div>
                        </tr>
                        <tr>
                            <td><a href="cart.php" class="btn btn-warning"><i class="fa fa-angle-right"></i>  Editer Panier</a></td>
                            <td colspan="2" class="hidden-xs"></td>
                            <div id="issessionset"></div>
                        </tr>
						<!-- /store bottom filter -->
